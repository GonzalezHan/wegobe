  ...
  return (
    ...
    <section ref={ref} className="h-[600vh] bg-white relative w-full">
      ...
      >
        ...
        >
          <div className="z-10 text-left max-w-xl md:w-1/2">
            <span className="text-purple-600 font-bold tracking-wider text-sm uppercase block mb-4">Step 2. Automation Merge</span>
        ...
        >
          <div className="z-10 text-center max-w-4xl mb-16 px-4">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight">
              ...
              이 모든 과정이 <span className="text-green-600">클릭 한번에</span>.
            </h2>
            <p className="mt-5 text-lg text-slate-600">
              산재된 데이터 조각은 정돈된 리포트와 시각화로 바뀌고, 필요한 사람에게 즉시 공유됩니다.
            </p>
          </div>
          ...
          <div className="w-full max-w-4xl bg-white border border-slate-200 shadow-xl rounded-xl p-6 relative pointer-events-auto mx-4">
            <div className="flex items-center gap-3 mb-6">
              <div className="flex flex-col">
                <h3 className="text-xl font-bold text-slate-800">경영기획 주간보고</h3>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  테리우스, 주간보고 내용 공유드립니다. <CheckCircle2 size={14} className="inline text-green-500"/>
                </p>
              </div>
            </motion.div>
          </div>
